...
export default function EditAvatarPopup(props) {
  ...
  return (
    <PopupWithForm onSubmit={handleSubmit} onClose={props.onClose} isOpen={props.isOpen} name='window_edit-avatar' title='Обновить аватар' buttonText={props.buttonText}>
